		...
		$.getJSON(makeUrl("streams", channel), function(data){
			...
			$.getJSON(makeUrl("channels", channel), function(data){
				...
				var html = `<div class="row ${status}"><div class="col-xs-2 col-sm-1" id="icon">
						<img src="${logo}" class="logo"></div><div class="col-xs-10 col-sm-3" id="name">
						<a href="${data.url}" target="_blank">${name}</a></div><div class="col-xs-10 col-sm-8" id="streaming">
...
var makeUrl = (type, name) => 'https://api.twitch.tv/kraken/' + type + '/' + name + '?callback=?';
